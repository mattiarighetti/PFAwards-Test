...
# Prepara PDF
set html "<html><table border=\"0\" cellpadding=\"1px\" cellspacing=\"1px\" width=\"100%\">"
# Imposta titolo testata
set title "Codice esame "
...
set data_ese [db_string query "select to_char(start_time, 'DD/MM/YYYY') from awards_esami where esame_id = :esame_id"]
set dalle [db_string query "select to_char(start_time, 'HH24:MI') from awards_esami where esame_id = :esame_id"]
set alle [db_string query "select to_char(end_time, 'HH24:MI') from awards_esami where esame_id = :esame_id"]
set tempo [db_string query "select to_char(end_time - start_time, 'MI') from awards_esami where esame_id = :esame_id"]
append html "<tr><td colspan=\"1\" width=\"80%\"><font size=\"3em\" face=\"Helvetica\"><img src=\"http://images.professionefinanza.com/logos/pfawards.png\" height=\"200px\"></img><br><br>$title</font><br><font size=\"2.5em\" face=\"Helvetica\">Nominativo: $nominativo <small>(Codice persona: $persona_id)</small></font><br><font size=\"2.5em\" face=\"Helvetica\">Categoria: <u>$categoria</u><br><font size=\"2.3em\" face=\"Helvetica\">Data: $data_ese dalle $dalle alle $alle<br><small><b>Tempo: $tempo minuti</b></small></font></td>"
append html "<td><center><font face=\"Helvetica\" size=\"0.5em\"><b>Punteggio totale:</b></font><br><font face=\"Courier New\" size=\"18px\"><b>$punteggio</b></font></center></td></tr><tr><td colspan=\"2\"><br>&nbsp;<br></td></tr></table><table border=\"1\" bordercolor=\"#e0e0e0\" cellpadding=\"1\" width=\"100%\">"
...
db_foreach query "SELECT rispusr_id FROM awards_rispusr WHERE esame_id = :esame_id ORDER BY item_order" {
    ...
    set domanda [string map {à &agrave; À &Agrave; è &egrave; é &eacute; È &Egrave; É &Eacute; ò &ograve;} [db_string query "SELECT d.testo FROM awards_domande d, awards_rispusr r WHERE d.domanda_id = r.domanda_id AND r.rispusr_id = :rispusr_id"]]
    append html "<tr><td width=\"25px\"><center>$counter</center></td><td colspan=\"2\"><font face=\"Times New Roman\" size=\"1px\"><b>$domanda</b></font></td></tr>"
	...
	set risposta [string map {à &agrave; À &Agrave; è &egrave; é &eacute; È &Egrave; É &Eacute; ò &ograve;} [db_string query "SELECT testo FROM awards_risposte WHERE risposta_id = :rispostadata_id"]]
	...
	if {$punti > 0} {
	    append html "<tr><td><center><img src=\"http://images.professionefinanza.com/icons/tic.png\" width=\"10px\"></img></center></td><td><font size=\"1px\" face=\"Times New Roman\">&bull;   $risposta</font></td><td><center><b>$punti</b></center></td></tr>"
	} else {
	    append html "<tr><td><center><img src=\"http://images.professionefinanza.com/icons/delete.gif\" width=\"10px\"></img></center></td><td><font size=\"1px\" face=\"Times New Roman\">&bull;   $risposta</font></td><td><center><b>$punti</b></center></tr>"
	}
	...
	db_foreach query "SELECT risposta_id FROM awards_risposte WHERE domanda_id = :domanda_id AND risposta_id <> :rispostadata_id ORDER BY RANDOM()" {
	    set risposta [string map {à &agrave; À &Agrave; è &egrave; é &eacute; È &Egrave; É &Eacute; ò &ograve;} [db_string query "SELECT testo FROM awards_risposte WHERE risposta_id = :risposta_id"]]
	    set punti [db_string query "SELECT punti FROM awards_risposte WHERE risposta_id = :risposta_id"]
	    if {$punti > 0} {
		append html "<tr><td><center><small>Giusta</small></center></td><td><font size=\"1px\" face=\"Times New Roman\">&bull;   $risposta</font></td><td><center><small>($punti)</small></center></td></tr>"
	    } else {
		append html "<tr><td>&nbsp;</td><td><font size=\"1px\" face=\"Times New Roman\">&bull;   $risposta</font></td><td>&nbsp;</td></tr>"
	    }
	}
    } else {
	...
	db_foreach query "SELECT risposta_id FROM awards_risposte WHERE domanda_id = :domanda_id ORDER BY RANDOM()" {
            ...
            set punti [db_string query "SELECT punti FROM awards_risposte WHERE risposta_id = :risposta_id"]
            if {$punti > 0} {
                append html "<tr><td><center><small>Giusta</small></center></td><td><font size=\"2.3em\"face=\"Times New Roman\">&bull;   $risposta</td><td><center><small>($punti)</small><center></font></td></tr>"
            } else {
                append html "<tr><td>&nbsp;</td><td><font size=\"2.3em\" face=\"Times New Roman\">&bull;   $risposta</font></td><td>&nbsp;</td></tr>"
            }
        }
    }
    incr counter
...
if {[db_0or1row query "select * from awards_bonus where esame_id = :esame_id limit 1"]} {
    ...
    set descrizione [string map {à &agrave; À &Agrave; è &egrave; é &eacute; È &Egrave; É &Eacute; ò &ograve;} [db_string query "select descrizione from awards_bonus where esame_id = :esame_id limit 1"]]
...
with_catch error_msg {
    exec htmldoc --portrait --webpage --header ... --footer ... --quiet --left 1cm --right 1cm --top 2mm --bottom 2mm --fontsize 10 -f $filenamepdf $filenamehtml
} {
