...
# Controlla cookie se non impostato ID Esame
if {![info exists esame_id]} {
    set esame_id [ad_get_cookie esame_id]
}
# Imposta tempo finale se non già impostato
if {[db_0or1row query "select * from awards_esami_2 where esame_id = :esame_id and end_time is null"]} {
    db_dml query "update awards_esami_2 set end_time = current_timestamp where esame_id = :esame_id"
}
# Prepara PDF in html
...
append html "<tr><td colspan=\"1\" width=\"80%\"><center><font size=\"4em\" face=\"Helvetica\"><img src=\"http://images.professionefinanza.com/logos/pfawards.png\" height=\"30px\"></img><br><br>$title</font><br><font size=\"3em\" face=\"Helvetica\">Credenziali: $nominativo <small>(Codice persona: $persona_id)</small></font><br><font size=\"3em\" face=\"Helvetica\">Categoria: <u>$categoria</u><br></font></td></tr></table><table border=\"1\" cellpadding=\"5\" bordercolor=\"#cbcbcb\" width=\"100%\">"
